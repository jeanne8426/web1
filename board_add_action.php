<html>
    ...
    <body>
        ...
        <?php
            ...
            $sql = "INSERT INTO board (board_pw, board_title, board_content, user_id, board_date) values ('".$_POST["boardPw"]."','". $_POST["boardTitle"]."','".$_POST["boardContent"]."','".$_POST["boardUser"]."',now())";
            ...
            header("Location: http://localhost/libse/board_list.php"); //헤더 함수를 이용해서 리다이렉션 시킬 수 있다.
        ?>
    </body
</html>
