<html>
    ...
    <body>
        ...
        <?php
            ...
            $sql = "UPDATE board SET board_title='".$board_title."',board_content='".$board_content."',board_date=now() WHERE board_id=".$board_id."";
            ...
            mysqli_close($conn);
            //헤더를 이용한 리다이렉션 구현
            header("Location: http://127.0.0.1/libse/board_list.php");
        ?>
    </body
</html>
